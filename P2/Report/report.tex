...
sorteáveis, com todas as saídas sorteáveis. Abaixo são apresentados os circuitos com as suas respectivas saídas desejadas:
...
Nesse primeiro circuito, chamar-se-á de $ u_1 = 3\text{A} $ e $ u_2 = 4u(t)\text{A} $. Além disso, $ x_1 = V_C $ e $ x_2 = I_L $.
...
\begin{figure}[h!]
    ...
    \begin{circuitikz}[scale=0.8]
        ...
        \draw (12.2,0.5) node[right]{$ - $}
              (12.2,1.5) node[right]{$ \text{V}_\text{R} $}
              (12.2,2.5) node[right]{$ + $};
        \draw (12,3) -- (15,3);
...
No segundo circuito, chamar-se-á de $ u_1 = 80\text{V} $ e $ u_2 = 10\text{A} $. Além disso, $ x_1 = V_C $ e $ x_2 = I_L $.
Por fim, $ y_1 = V_C $, $ y_2 = I_L e $ $ y_3 = V_R $.
